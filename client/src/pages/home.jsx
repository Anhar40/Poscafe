    ...
    return (<div className="min-h-screen bg-coffee-50">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-coffee-600 text-sm">
                Selamat datang, {user?.firstName || user?.username || 'User'}
              </p>
            </div>
          </div>
          
          <Button onClick={handleLogout} variant="destructive" className="flex items-center space-x-2">
            <LogOut size={16}/>
            <span>Keluar</span>
          </Button>
        </div>
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {user?.role === 'admin' && (<Link href="/menu-management">
              <Card className="cursor-pointer hover:shadow-lg transition-all duration-200 border-2 hover:border-coffee-300">
                <CardHeader className="text-center">
          ...
          {user?.role === 'admin' && (<Card className="cursor-pointer hover:shadow-lg transition-all duration-200 border-2 hover:border-coffee-300 opacity-75">
              <CardHeader className="text-center">
