...
export default function Dashboard() {
  ...
  // Handle errors
  useEffect(() => {
    if (salesError && isUnauthorizedError(salesError as Error)) {
      toast({
        title: "Unauthorized",
        description: "You are logged out. Logging in again...",
        variant: "destructive",
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-coffee-800">
                    {salesLoading ? (
                      ...
                      `Rp ${Math.round(salesData?.averageTransaction || 0).toLocaleString('id-ID')}`
                    )}
                  </p>
                </div>
                ...
                <Table>
                  ...
                  <TableBody>
                    {transactions && transactions.length > 0 ? (
                      transactions.slice(0, 10).map((transaction: TransactionWithDetails) => (
