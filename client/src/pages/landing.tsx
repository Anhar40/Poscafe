...
const loginMutation = useMutation({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-coffee-400 to-coffee-600 p-4">
      <Card className="w-full max-w-md shadow-2xl">
        ...
        <CardContent className="space-y-4">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 border-coffee-200 focus:border-coffee-400"
                  disabled={loginMutation.isPending}
                />
                <button
                  type="button"
            ...
            <Button 
              type="submit"
              className="w-full bg-coffee-500 hover:bg-coffee-600 text-white py-2.5 mt-6"
              disabled={loginMutation.isPending}
            >
